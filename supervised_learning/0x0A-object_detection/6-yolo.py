...
class Yolo:
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        ...
        :param boxes: a numpy.ndarray containing the boundary boxes for the
        image
        :param box_classes: a numpy.ndarray containing the class indices for
        each box
        :param box_scores: a numpy.ndarray containing the box scores for each
        box
        :param file_name: the file path where the original image is stored
        :return: no return
        """
